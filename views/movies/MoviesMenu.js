...
const MoviesMenu = (props)=>{
    ...
    useEffect(()=>{
        Movies.getMoviesData().then(resp=>props.dispatch({
            type: "SET",
            payload: resp.data
        }));
    ...
    return(
        <div>
            ...
            <Switch>
                <Route path="/main/moviesMenu/allMovies" render={() => <AllMovies subscriptions={subscriptions} members={members}/>} />
...
export default connect()(MoviesMenu);