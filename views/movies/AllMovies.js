...
const AllMovies = (props) => {
  ...
  //movies share via redux
  let allMovies = props.data.movies.map((movie, index) => {
    if (findIsOn && movie.Name.includes(movieFound)) {
      return (
        <li key={index} className="allMovies">
          ...
          <div style={{ float: "left", textAlign: "left" }}>
            <img
              src={movie.Image}
              alt=""
              style={{ height: 100, float: "left", marginTop: 2 }}
            />
            <div
              className="SubscriptionsWatched"
              style={{ marginTop: -100, height: 94 }}
            >
          ...
          <div style={{ marginTop: 5, float: "left" }}>
            <Link to={`/main/moviesMenu/editMovies/${movie.Name}`}>
      ...
      return (
        <li key={index} className="allMovies">
          ...
          <div style={{ marginTop: 5, float: "left" }}>
            ...
            <Link to={`/main/moviesMenu/deleteMovies/${movie.Name}`}>
              <button className="btn">Delete</button>
            </Link>
          </div>
        </li>
  ...
  return (
    <div style={{}}>
      ...
      <button style={{ marginLeft: 5 }} onClick={find}>
        Find
      </button>
      <ul>{allMovies}</ul>
    </div>
