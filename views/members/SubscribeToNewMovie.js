...
const SubscribeToNewMovie = (props) => {
  ...
  const onSubmit = (data) => {
    ...
    Subscriptions.saveSubscriptionsData(subscriptionObj).then((resp) =>
          ...
          <div className="userDataSubscribe">
            <div className="emailCityBtns">
              <form>
                ...
                <Link
                  to={`/main/subscriptionsMenu/deleteMovies/${member.Name}`}
                >
...
export default withRouter(SubscribeToNewMovie);
